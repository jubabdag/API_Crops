...
public class VariedadeController {
    ...
    // Inseri um Variedade
    @PostMapping
    public @ResponseBody Variedade cadastrarVariedade(@RequestBody Variedade variedade){
        Variedade novaVariedade = new Variedade();
        novaVariedade.setNomeVariedade(variedade.getNomeVariedade());
        return variedadeRepository.save(novaVariedade);
    }
